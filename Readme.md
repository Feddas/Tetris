...
Make a WebGL version playable at https://Feddas.github.io/Tetris
...
5. wait for github.com to build the page. Status can be checked on https://github.com/Feddas/Tetris/settings/pages.
6. fetch from the remote repo in your old repo.

# Repo

https://github.com/Feddas/Tetris/tree/gh-pages
